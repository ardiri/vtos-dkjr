    ...
    case EVT_BITMAP_SELECT:
         ...
         switch (event->eventID) 
         {
           ...
           case mainFormGameAHighBitmap:
                ...
                globals->prefs->game.dkjr.gameType = GAME_A; 
           ...
           case mainFormGameBHighBitmap:
                ...
                globals->prefs->game.dkjr.gameType = GAME_B; 
    ...
    case EVT_INLAY_SELECT:
         ...
         switch (event->para1) 
         {
           case INLAY_EXIT:
                ...
                switch (globals->prefs->game.dkjr.gameType) 
                {
                  case GAME_A:
         ...
         switch (event->eventID) 
         {
           ...
           case gameFormResetBitmap:
                GameReset(globals->prefs,
                          globals->prefs->game.dkjr.gameType);
  ...
  switch (event->eventType)
  {
    case EVT_FORM_OPEN:
         ...
         // display the high score/code to the user
         {
           ...
           GfxDrawString(str, strlen(str), x, y, gfxPaint);
           y += GfxGetFontHeight();
           strcpy(str, (globals->prefs->game.dkjr.gameType == GAME_A) 
                       ? "GAME A" : "GAME B");
           GfxDrawString(str, strlen(str), x, y, gfxPaint);
           y += GfxGetFontHeight();
           if (globals->prefs->game.dkjr.gameType == GAME_B) 
             globals->prefs->game.gameScore += 1000;
           {
             BYTE  code[16] = "ZUTHWKSLBNXPQWGA";
